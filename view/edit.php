...
<?php foreach($products as $product):?>
    ...
    <form action="/update" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="file" placeholder="product_image" name="image" require value="<?=$product->product_image;?>">
            </div>
            <div>
            ...
            <div>
                ...
                <select name="brand" id="products" class='select' value="<?=$product->brand;?>">
